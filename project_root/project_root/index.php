...
<head>
    ...
    <title>Home - African Fashion Marketplace</title>
        ...
        <?php if ($is_logged_in): ?>
            ...
            <div class="user-info">
                ...
                <div>
                    ...
                    <?php if ($is_admin): ?>
                        <span class="role-badge" style="background: #dc3545;">Admin</span>
                    <?php endif; ?>
                </div>
            </div>
            <div class="d-flex justify-content-between align-items-center">
                ...
                <?php if ($is_admin): ?>
                    <a href="admin/category.php" class="btn btn-sm btn-warning me-2">
    ...
    <div class="container welcome-section">
        <div class="text-center">
            <?php if ($is_logged_in): ?>
                ...
                <?php if ($is_admin): ?>
                    <div class="mt-4">
                        <a href="admin/category.php" class="btn btn-warning btn-lg">
            ...
            <?php else: ?>
                <h1>Welcome to African Fashion Marketplace</h1>
